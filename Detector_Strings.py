...
def scan_file(path):
    ...
    if not os.path.exists("saved_detector_Strings.pkl"):
        print("It appears you haven't trained a detector yet!  Do this before scanning files.")
        sys.exit(1)
    with open("saved_detector_Strings.pkl","rb") as saved_detector:
...
def train_detector(benign_path,malicious_path,hasher):
    ...
    pickle.dump((classifier,hasher),open("saved_detector_Strings.pkl","wb+"))
